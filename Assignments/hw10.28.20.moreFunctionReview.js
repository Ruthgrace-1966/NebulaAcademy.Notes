...
// }
// console.log(initials('Anitria', 'Blue'));        //AB
// console.log(initials('Jasmine', 'Dyson'));       //JD
//``This is a Dynamic problem.


// PROBLEM 2
// // Create a function called bool that returns the Boolean of any argument passed into it.
// function bool (jasmine){
//     return Boolean(jasmine)
// }
...
// // This function will replace all a's in the string passed into the function with a '-'.
// function replaceA (success){
//     return success.replace( /a/gi, '-')
// }
//  console.log(replaceA('Student at Nebula'));
//  console.log(replaceA('Alabama'));
...
// function characterAt (college){
//     return college.charAt(5)
// }
// console.log(characterAt('Hofstra University'));


// // PROBLEM 5
// // Create a function called squareRoot that takes in a number as a parameter.
// // This function will return the square root of any number that is passed in as an argument.
function squareRoot (seven){
    return Math.sqrt(seven)
}
